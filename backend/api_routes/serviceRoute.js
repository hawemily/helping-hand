...
router.post("/laundry", (req, res) => {
    const {load, dateOfPickup, timeOfPickup, dateOfDropOff, timeOfDropOff, basket, detergent, pinId} = req.body;
    ...
    newLaundryRun.save().then((laundryRun) => {
        createService(laundryRun, "Laundry", pinId, dateOfPickup, timeOfPickup, res);
    });
});
